...
public class ParticipantSelectionListFragment extends ListFragment {
    ...
    public static ParticipantSelectionListFragment newInstance(Participant[] _participants ) {
    ...
    public void onStart(){
        ...
        if(participants==null || participants.length==0 ){
            ...
            adapter = new ParticipantSelectionListAdapter(getActivity(), participants);
